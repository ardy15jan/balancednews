...
public class IntroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        */
        ...
        Button subjectButton = (Button) rootView.findViewById(R.id.intro_subject_button);
        if(subjectButton != null){
            subjectButton.setTypeface(FontManager.getRobotoLight(getActivity()));
            subjectButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(getActivity(), "A collection of articles discussing the same event or topic", Toast.LENGTH_LONG).show();
                }
            });
        }
