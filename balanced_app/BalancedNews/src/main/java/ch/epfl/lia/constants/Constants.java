...
import ch.epfl.lia.customized.ActivityHolder;
...
public class Constants {
    ...
    public static final int VERSION = "balanced".hashCode();
    ...
    public static boolean showIntroNews = false;
