...
import ch.epfl.lia.customized.IntroPagerAdapter;
...
public class IntroActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        layoutIDs.add(R.layout.intro_page_opinion);
        layoutIDs.add(R.layout.intro_page_news);

        layoutIDs.add(R.layout.intro_page_navigate_opinion);
